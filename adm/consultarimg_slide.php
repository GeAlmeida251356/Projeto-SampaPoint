...
<section class="container" style="top: 50%;">
        <body class="bg-dark">
						<div class="row">
							...
							<div class="row">
                                <form action="upload_slide.php" onchange="previewImagem()" method="post" enctype="multipart/form-data">
								<div class="col-12 mb-3">
                                    <input type="number" value="<?php echo $dado['codLocal']; ?>" readonly >
                                </div>

								<div class="col-12 mb-3">
                                <label for="arquivo" class="labelInput">Clique para selecionar as imagens:
                                    <input type="file" name="arquivo[]" multiple id="arquivo" required/><br>
									<?php 
									}
									?>
								</label>
								...
								<div class="col-12 mb-3">
                                    <input name="codigo" type="hidden" value="<?php echo $codigo; ?>" name="codigo">
                                </div>
                            </div>    
						    <div class="row">
							<div class="col">
						    ...
						    <div class="col">    
						        <button onclick="window.location='imagem_slide.php';" value="Voltar">Voltar</button>  
						    </div>
                            </div>
        </section>
</body>
